    ...
    <div style={{ background:T.ink, color:T.white, fontFamily:T.fontBody, overflowX:"hidden" }}>
      ...
      <nav style={{ position:"fixed", top:0, left:0, right:0, zIndex:200, display:"flex", alignItems:"center", justifyContent:"space-between", padding:"1.25rem 4rem", background:scrolled?"rgba(10,15,30,.96)":"rgba(10,15,30,.55)", backdropFilter:"blur(20px)", borderBottom:scrolled?`1px solid ${T.border}`:"1px solid transparent", transition:"all .35s" }}>
        ...
        <div style={{ display:"flex", alignItems:"center", gap:"1.75rem" }}>
          <a href="#features"     className="nav-link-land">Features</a>
          <a href="#how-it-works" className="nav-link-land">How It Works</a>
          <a href="#pricing"      className="nav-link-land">Pricing</a>
          <a href="#testimonials" className="nav-link-land">Reviews</a>
          {session ? (
      ...
      <section style={{ minHeight:"100vh", display:"flex", flexDirection:"column", justifyContent:"center", padding:"8rem 4rem 5rem", position:"relative", overflow:"hidden" }}>
        ...
        <div style={{ position:"relative", zIndex:1, maxWidth:940 }}>
          ...
          <div style={{ display:"flex", gap:"1rem", flexWrap:"wrap", marginTop:"3rem", opacity:0, animation:"fadeUp .9s .5s cubic-bezier(.16,1,.3,1) forwards" }}>
            ...
            <button onClick={() => document.getElementById("how-it-works")?.scrollIntoView({ behavior:"smooth" })} className="btn-land-secondary" style={{ fontSize:".9rem", padding:".9rem 2.25rem" }}>
              See How It Works
            </button>
          </div>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(260px,1fr))", gap:"1.5rem" }}>
            {[
              ...
              <div key={f.title} className={`feat-card reveal`} style={{ animationDelay:`${i*.08}s`, transitionDelay:`${i*.08}s` }}
                onClick={() => f.href && navigate(f.href)} style2={{ cursor:f.href?"pointer":"default" }}>
      ...
      <section id="how-it-works" style={{ padding:"8rem 4rem", background:T.mid, position:"relative", zIndex:1 }}>
        <div style={{ maxWidth:1000, margin:"0 auto" }}>
          <div className="reveal" style={{ marginBottom:"4rem" }}>
            ...
            <h2 style={{ fontFamily:T.fontDisplay, fontWeight:800, fontSize:"clamp(2rem,5vw,3.5rem)", color:T.white, letterSpacing:"-.03em" }}>Up and running<br/>in minutes</h2>
          </div>
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit,minmax(210px,1fr))", gap:"2rem" }}>
            {[
              { n:"01", title:"Create Account",   desc:"Sign up free. No credit card required. Your workspace is ready instantly.", action:goLogin,                   cta:"Sign Up Free"  },
              { n:"02", title:"Set Up Your Org",  desc:"Add your business name, logo, and team members in Settings.",              action:()=>navigate("/settings"), cta:"Go to Settings" },
              { n:"03", title:"Add Employees",    desc:"Import or manually add staff with salaries and bank details.",              action:()=>navigate("/payroll"),  cta:"Open Payroll"  },
              { n:"04", title:"Start Transacting",desc:"Create invoices, run payroll, upload receipts, and open your teller.",     action:()=>navigate("/dashboard"),cta:"Open Dashboard" },
            ].map((s,i) => (
              <div key={s.n} className="step-card reveal" style={{ transitionDelay:`${i*.1}s` }}>
                ...
                <div style={{ fontSize:".82rem", color:T.slate, lineHeight:1.75, marginBottom:"1.25rem" }}>{s.desc}</div>
                <button onClick={s.action} style={{ background:"none", border:`1px solid ${T.border}`, color:T.gold, fontFamily:T.fontMono, fontSize:".62rem", letterSpacing:".08em", padding:".35rem .75rem", cursor:"pointer", transition:"all .2s" }}
      ...
      <section style={{ padding:"8rem 4rem", position:"relative", zIndex:1, overflow:"hidden", textAlign:"center" }}>
        ...
        <div style={{ position:"relative", maxWidth:640, margin:"0 auto" }} className="reveal">
          ...
          <div style={{ display:"flex", gap:"1rem", justifyContent:"center", flexWrap:"wrap" }}>
            ...
            <button onClick={() => document.getElementById("features")?.scrollIntoView({ behavior:"smooth" })} className="btn-land-secondary" style={{ fontSize:"1rem", padding:"1rem 2.5rem" }}>
              Learn More
            </button>
          </div>
        </div>
      ...
      <footer style={{ background:T.mid, borderTop:`1px solid ${T.border}`, padding:"3rem 4rem", zIndex:1, position:"relative" }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:"1.5rem", marginBottom:"2rem" }}>
          ...
          <div style={{ display:"flex", gap:"2rem", flexWrap:"wrap" }}>
            {[["Features","#features"],["How It Works","#how-it-works"],["Pricing","#pricing"],["Reviews","#testimonials"]].map(([l,h]) => (
              <a key={l} href={h} style={{ fontFamily:T.fontMono, fontSize:".62rem", color:T.slate, letterSpacing:".08em", textDecoration:"none", transition:"color .2s", textTransform:"uppercase" }}
...
function RecentTransactions({ supabase }) {
  ...
  return (
    <table style={{ width:"100%", borderCollapse:"collapse" }}>
      <thead>
        <tr>{["Reference","Type","Amount","Date"].map(h => <th key={h} style={{ fontFamily:T.fontMono, fontSize:".6rem", color:T.slate, letterSpacing:".1em", textTransform:"uppercase", textAlign:"left", paddingBottom:".75rem", borderBottom:`1px solid ${T.border}` }}>{h}</th>)}</tr>
      </thead>
      <tbody>
        {rows.map(r => (
          <tr key={r.id}>
